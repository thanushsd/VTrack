            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="../assets/images/admin.png"
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                ...
                                <h6><?php echo $tel ?></h6> <small class="text-muted p-t-30 db">Address</small>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password" placeholder="<?php echo $pw ?>" 
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="<?php echo $tel ?>"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="<?php echo $gender ?>"
                                                class="form-control form-control-line">
                                    ...
                                    <label class="col-md-12">Adress</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="<?php echo $adress ?>"
                                                class="form-control form-control-line">                                        
                                </div><br>
                                    <div class="form-group">
                                        <div class="col-sm-12">
