            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img alt="No Image"  src="../assets/uimg/<?php echo $pp ?>"
                                        class="rounded-circle" width="150" />
                                    <h4 class="card-title m-t-10"><?php echo $title ?> <?php echo $name ?></h4>
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                ...
                                <h6><?php echo $tel ?></h6>
                                <small class="text-muted p-t-30 db">Work</small>
                                <h6><?php echo $comp ?></h6>
                                <small class="text-muted p-t-30 db">Added Date</small>
                                <h6><?php echo $date ?></h6>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input disabled type="password" placeholder="<?php echo $uname ?>" 
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
