                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">RDA Officer Accounts</li>
                            </ol>
                          </nav>
                        <h1 class="mb-0 fw-bold">RDA Officer Accounts</h1> 
                    </div>
                    <div class="col-6">
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        <h4 class="card-title">RDA Officer Accounts</h4>
                                        <h5 class="card-subtitle">Added RDA Officer Accounts</h5>
                                    </div>
                                    <div class="ms-auto">
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0 table-hover align-middle text-nowrap">
                                        ...
                                        <tbody>
                                             <?php
    $sql=" SELECT * FROM user WHERE roll=4";
    $result=$conn->query($sql);
    while($row=$result->fetch_assoc())
    {
        $name=$row["name"];
