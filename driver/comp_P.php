...
.custom-file-upload {
    ...
    margin-top: 5px;
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <form action="../sql/comp_p.php" class="form-horizontal form-material mx-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="nic" placeholder="<?php echo $nic ?>"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input disabled type="email" placeholder="<?php echo $uname ?>"
                                                class="form-control form-control-line" name="example-email"
                                                id="example-email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="tel" type="text" placeholder="<?php echo $tel ?>"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <label class="col-md-12">Adress</label>
                                        <div class="col-md-12">
                                           <textarea class="form-control" name="add" placeholder="Enter Address" > 
                                           </textarea>                                        
                                </div><br>
                                <div class="form-group">
                                    <input type="submit" value="Complete Profile" class="btn btn-info w-50" style=" color: white; font-weight: bold; " >                                 
                                </div>
