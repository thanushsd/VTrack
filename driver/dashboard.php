...
<script type="text/javascript">
  ...
  text: 'Driver <?php echo $title ?> <?php echo $name ?> Logged In ',
...
<script type="text/javascript">
        function addacc() {
            Swal.fire({
  icon: 'success',
  title: 'Acciedent Successfully Recorded !',
  text: 'Vehilce <?php echo $vid ?> Accident Recorded ',
  confirmButtonColor: "#189cfc",
  iconColor: '#189cfc',
  confirmButtonText: "Okay",
})
...
<?php 
            if ($name==null) { ?>
<div style=" border-radius: 20px; " class="alert alert-info alert-dismissible fade show" role="alert">
  <strong>Please <a href="comp_P.php" >Complete</a> Your Profile</strong> 
