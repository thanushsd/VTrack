...
?>  
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <?php include 'rdac/header.php';?>
        <?php include 'rdac/sidebar.php';?>
...
<form id="form" action="../sql/rdappup.php?uid=<?php echo $uid ?>" enctype="multipart/form-data" method="post">
